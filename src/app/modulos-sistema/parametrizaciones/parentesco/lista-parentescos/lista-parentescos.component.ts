...
@Component({
  selector: 'app-lista-parentescos',
  templateUrl: './lista-parentescos.component.html',
  styleUrls: ['./lista-parentescos.component.css']
})
export class ListaParentescosComponent implements OnInit {
  ...
  ngOnInit() {
    this.controladorParametrizacion.SetTipo("parentescos");
    this.controladorParametrizacion.buscarDatosLista().add(
      response =>{
        this.listaParentescos  = this.controladorParametrizacion.GetListaDatos();
      }
    );
  }
